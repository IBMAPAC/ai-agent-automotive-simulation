...
// --- DEMO CONFIGURATION ---
// This object defines the entire content for the AutoForge Demo.
const config = {
    title: "AutoForge AI Manufacturing Simulation",
    subtitle: "Choose a scenario to simulate agentic AI behavior in automotive manufacturing:",
    // Define the 6 industry-specific agents
    agents: [
        { id: 'agent1', key: 'supply-chain-monitor', name: '📡 Supply Chain Monitor', desc: 'Monitors global events and suppliers for potential disruptions.' },
        { id: 'agent2', key: 'quality-control', name: '🔬 Quality Control', desc: 'Analyzes sensor data from equipment to predict maintenance needs.' },
        { id: 'agent3', key: 'production-planner', name: '🎯 Production Planner', desc: 'Manages production schedules and orchestrates responses to events.' },
        { id: 'agent4', key: 'logistics-coordinator', name: '🚚 Logistics Coordinator', desc: 'Coordinates the movement and procurement of parts and resources.' },
        { id: 'agent5', key: 'engineering-ops', name: '⚙️ Engineering Ops', desc: 'Manages technical specifications and assigns maintenance tasks.' },
        { id: 'agent6', key: 'factory-optimizer', name: '🔁 Factory Optimizer', desc: 'Simulates and optimizes factory processes using digital twins.' }
    ],
        ...
        supplyChainCrisis: {
            ...
            steps: [
                ...
                { text: "🎯 Production Planner assesses the impact: estimates that the current chip inventory will only sustain production for 72 hours.", bubble: ["production-planner", "72 hours of production left."], agent: "production-planner", handoffTo: "supply-chain-monitor", 
                  ...
                  challenge: "<h3>Real-Time Data Integration</h3><p>To be accurate, the impact assessment requires instant access to constantly changing data from siloed systems (e.g., ERP, Inventory Management, MES). A lag or data sync error could make the assessment dangerously incorrect.</p><p><strong>Potential Solutions:</strong></p><ul><li>Use <strong>webMethods Hybrid Integration</strong> to provide the robust integration layer needed to connect disparate factory and enterprise systems.</li><li>Secure the credentials for these connections using <strong>Hashicorp Vault</strong>, which provides the agent with audited, on-demand access to secrets.</li><li>Leverage <strong>watsonx.data</strong> to provide a single, virtualized access point to all necessary data sources.</li></ul>"
                },
        ...
        predictiveMaintenance: {
            ...
            steps: [
                { text: "‼️ PREDICTIVE ALERT: Quality Control agent detects a subtle vibration anomaly in a critical welding robot on Assembly Line 3.", bubble: ["quality-control", "Vibration anomaly on Robot #7."], agent: "quality-control", type: 'event', handoffTo: "engineering-ops", 
                  ...
                  challenge: "<h3>Sensor Data Quality & Volume</h3><p>The system's accuracy depends on high-quality, high-volume sensor data. This requires a data platform capable of handling massive streams of IoT data in real time.</p><p><strong>Potential Solutions:</strong></p><ul><li>Use <strong>Datastax</strong> as the high-performance, time-series data store to ingest and query massive volumes of IoT sensor data from factory equipment.</li><li>Leverage <strong>IBM Maximo</strong> to manage the physical asset data and maintenance history, providing crucial context to the sensor readings.</li></ul>"
                },
                ...
                { text: "COLLABORATIVE ACTION: Logistics Coordinator orders the replacement bearing to be delivered to Line 3, while Engineering Ops assigns a maintenance technician.", agent: ['logistics-coordinator', 'engineering-ops'], bubble: ["logistics-coordinator", "Part ordered. Tech assigned."], 
                  ...
                  challenge: "<h3>Workflow Reliability Across Systems</h3><p>This single action requires integrating with multiple enterprise systems: inventory (SAP), HR, and asset management (<strong>IBM Maximo</strong>). A failure in any one of these integrations could derail the entire process.</p><p><strong>Potential Solutions:</strong></p><ul><li>Use <strong>webMethods Hybrid Integration</strong> to handle the complex, cross-platform integrations between the AI agents and the different enterprise applications.</li><li>Use <strong>watsonx Orchestrate</strong> to manage the high-level workflow that calls upon these integrations.</li></ul>"
                }
            ]
        },
        newModelRollout: {
            name: "🚗 New Model Rollout",
            steps: [
                ...
                { text: "🔁 Factory Optimizer runs a digital twin simulation of the new assembly line, identifying a potential bottleneck that reduces throughput by 12%.", bubble: ["factory-optimizer", "Simulation found a bottleneck!"], agent: "factory-optimizer", type: 'learning', handoffTo: "engineering-ops", 
                  ...
                  challenge: "<h3>Digital Twin Accuracy & Fidelity</h3><p>A digital twin simulation is only useful if it accurately reflects the real-world factory. The infrastructure must support this complex model.</p><p><strong>Potential Solutions:</strong></p><ul><li>Use <strong>Hashicorp Terraform</strong> to define and provision the specific, high-performance computing environment required for the digital twin simulation.</li><li>Use <strong>watsonx.ai</strong> to build the core simulation models and continuously update them with real-time operational data from <strong>Instana</strong> and asset data from <strong>IBM Maximo</strong>.</li></ul>"
                }
            ]
        }
    },
